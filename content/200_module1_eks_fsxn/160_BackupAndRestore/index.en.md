...
::code[cd /eks-fsx-workshop/eks/FSxN/mysql]{language=bash showLineNumbers=false showCopyAction=true}

:::
:::tab{id="windows" label="Windows"}

::code[cd /c/Users/Administrator/Desktop/eks-fsx-workshop/eks/FSxN/mysql]{language=bash showLineNumbers=false showCopyAction=true}

You should be in the current working directory as shown in the below screenshot
![windows_mysql](/static/images/Windows_mysql.png)

:::
:::tab{id="cloud9" label="Cloud9"}

::code[cd /home/ec2-user/environment/eks-fsx-workshop/eks/FSxN/mysql]{language=bash showLineNumbers=false showCopyAction=true}
