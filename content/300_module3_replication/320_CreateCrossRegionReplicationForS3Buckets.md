---
title : "Configure S3 Cross-Region Replication, test export and replication of data"
weight : 320
---
-------------------------------------------------------------
...
Imagine the scenario where you had to share your models, training data or assets generated by your Pods with EKS clusters in a different AWS region (i.e. for DR, or data sharing). In this lab section, you Configure S3 replication configuration (required for next module), to see how you can achieve S3 replication with your S3-linked Amazon FSx for Lustre instance, which you can use for your Pod(s) persistent Volumes (PV).
...
In this section, you have successfully created a S3 Cross Region Replication rule between two S3 buckets. You have created test data on a Persistent Volume mounted to one of your Pods, and observed how seamlessly your generated data gets copied to your linked S3-bucket and also replicated to the target S3 bucket using Amazon S3 native replication. Through this module you have learnt how you can use these  features to help you with data sharing scenarios, such as a DR/BCP plan for the containerized workload deployments.
