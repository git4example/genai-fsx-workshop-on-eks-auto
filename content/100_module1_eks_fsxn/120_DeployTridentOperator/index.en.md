...
Download the Trident v23.10.0 (or latest version) installer bundle from the [Trident Github](https://github.com/netapp/trident/releases) page. The installer bundle includes the Helm chart in the /helm directory.

### Download the file

::code[curl -L -o trident-installer-23.10.0.tar.gz https://github.com/NetApp/trident/releases/download/v23.10.0/trident-installer-23.10.0.tar.gz]{language=bash showLineNumbers=false showCopyAction=true}

### Extract the tar file downloaded

::code[tar -xvf ./trident-installer-23.10.0.tar.gz]{language=bash showLineNumbers=false showCopyAction=true}
...
::code[helm install trident -n trident trident-operator-23.10.0.tgz]{language=bash showLineNumbers=false showCopyAction=true}
