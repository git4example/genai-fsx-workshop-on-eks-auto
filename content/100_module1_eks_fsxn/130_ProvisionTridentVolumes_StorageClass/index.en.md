...
- Navigate to the **svm_secret.yaml** file stored in the **eks/FSxN** folder of **eks-fsx-workshop** folder in your environment.

::::tabs{variant="container" activeTabId="cloud9"}
:::tab{id="linux" label="Linux"}

::code[cd /eks-fsx-workshop/eks/FSxN]{language=bash showLineNumbers=false showCopyAction=true}
:::
:::tab{id="windows" label="Windows"}

::code[cd /c/Users/Administrator/Desktop/eks-fsx-workshop/eks/FSxN]{language=bash showLineNumbers=false showCopyAction=true}

You should be in the current working directory as shown in the below screenshot
![windows_FSxN](/static/images/Windows_FSxN.png)

:::
:::tab{id="cloud9" label="Cloud9"}

::code[cd /home/ec2-user/environment/eks-fsx-workshop/eks/FSxN]{language=bash showLineNumbers=false showCopyAction=true}
:::
::::
