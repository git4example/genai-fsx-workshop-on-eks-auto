...
FSX_VOLUME=$(aws fsx describe-volumes --query 'Volumes[?Name==`fsx`].VolumeId' --region $REGION_1 --output text)
:::
...
::code[cd /eks-fsx-workshop/eks/FSxZ/volume-maz]{language=bash showLineNumbers=false showCopyAction=true}
:::
:::tab{id="windows" label="Windows"}
::code[cd /c/Users/Administrator/Desktop/eks-fsx-workshop/eks/FSxZ/volume-maz]{language=bash showLineNumbers=false showCopyAction=true}
You should be in the current working directory as shown in the below screenshot
![windows_FSxZ](/static/images/Windows_FSxZ_volume.png)

:::
:::tab{id="cloud9" label="Cloud9"}
::code[cd /home/ec2-user/environment/eks-fsx-workshop/eks/FSxZ/volume-maz]{language=bash showLineNumbers=false showCopyAction=true}
::::
