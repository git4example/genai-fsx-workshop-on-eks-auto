...
::code[cd /eks-fsx-workshop/eks/FSxZ]{language=bash showLineNumbers=false showCopyAction=true}
:::
:::tab{id="windows" label="Windows"}

::code[cd /c/Users/Administrator/Desktop/eks-fsx-workshop/eks/FSxZ]{language=bash showLineNumbers=false showCopyAction=true}

You should be in the current working directory as shown in the below screenshot
![windows_FSxZ](/static/images/Windows_FSxZ.png)

:::
:::tab{id="cloud9" label="Cloud9"}
::code[cd /home/ec2-user/environment/eks-fsx-workshop/eks/FSxZ]{language=bash showLineNumbers=false showCopyAction=true}
:::
::::
