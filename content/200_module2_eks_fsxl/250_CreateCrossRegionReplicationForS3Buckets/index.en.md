...
For AWS Sponsored Workshop, The S3 bucket for FSx for lustre CSI driver is pre-created as the source with the name as **fsx-luster-bucket-xxxx** and the destination with the name as **fsx-luster-bucket-2ndregion-xxxx**
...
### Step 2: Open bucket **fsx-luster-bucket-xxxx** and Choose **Management**, scroll down to *Replication rules*, and then choose *Create replication rule*
...
:::alert{header="Note" type="info"}
For AWS Sponsored Workshop, the bucket is pre-created for you, please select the Bucket Name like **fsx-luster-bucket-2ndregion-xxxx**. If you are running the self-paced labs, please create the 2nd S3 bucket in another region.
:::
